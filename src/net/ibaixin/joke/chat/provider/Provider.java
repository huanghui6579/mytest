package net.ibaixin.joke.chat.provider;
...
public class Provider {
	public static final String AUTHORITY_USER = "net.ibaixin.joke.chat.provider.user";
	public static final String AUTHORITY_MSG = "net.ibaixin.joke.chat.provider.msg";
	public static final String AUTHORITY_NEW_FRIEND = "net.ibaixin.joke.chat.provider.newFriend";
