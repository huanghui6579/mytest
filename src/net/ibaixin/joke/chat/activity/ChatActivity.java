...
import net.ibaixin.joke.chat.fragment.EmojiFragment;
import net.ibaixin.joke.chat.fragment.EmojiTypeFragment;
import net.ibaixin.joke.chat.manage.MsgManager;
import net.ibaixin.joke.chat.model.AttachItem;
import net.ibaixin.joke.chat.model.EmojiType;
import net.ibaixin.joke.chat.model.FileItem;
import net.ibaixin.joke.chat.model.MsgInfo;
import net.ibaixin.joke.chat.model.MsgPart;
import net.ibaixin.joke.chat.model.MsgSenderInfo;
import net.ibaixin.joke.chat.model.MsgThread;
import net.ibaixin.joke.chat.model.Personal;
import net.ibaixin.joke.chat.model.User;
import net.ibaixin.joke.chat.model.UserVcard;
import net.ibaixin.joke.chat.model.MsgInfo.SendState;
import net.ibaixin.joke.chat.model.MsgInfo.Type;
import net.ibaixin.joke.chat.model.emoji.Emojicon;
...
import net.ibaixin.joke.chat.util.DensityUtil;
import net.ibaixin.joke.chat.util.Log;
import net.ibaixin.joke.chat.util.MimeUtils;
import net.ibaixin.joke.chat.util.SoundMeter;
import net.ibaixin.joke.chat.util.SystemUtil;
import net.ibaixin.joke.chat.util.XmppConnectionManager;
import net.ibaixin.joke.chat.view.EmojiconEditText;
import net.ibaixin.joke.chat.view.TextViewAware;
...
//	}
	...
	class MsgAdapter extends CommonAdapter<MsgInfo> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			holder.tvContent.setOnClickListener(new MsgItemClickListener(type, msgInfo));
...
//			holder.ivHeadIcon.setImageResource(R.drawable.ic_chat_default_big_head_icon);
	...
	class MsgItemClickListener implements View.OnClickListener {
		...
		public MsgItemClickListener(int itemType, MsgInfo msgInfo) {
			super();
	...
	public class MsgProcessReceiver extends BroadcastReceiver {
		public static final String ACTION_PROCESS_MSG = "net.ibaixin.joke.chat.PROCESS_ACCEPT_MSG_RECEIVER";
		public static final String ACTION_REFRESH_MSG = "net.ibaixin.joke.chat.REFRESH_ACCEPT_MSG_RECEIVER";
