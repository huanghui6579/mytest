...
import net.ibaixin.joke.chat.fragment.EmojiFragment2;
 ...
 */
public class ChatActivity2 extends BaseActivity implements OnClickListener/*, OnItemClickListener*/ {
...
//		etContent.setBackgroundResource(0);
	...
	protected void initData() {
		...
		for (int i = 0; i < ChatApplication.emojiTypeCount; i++) {
			...
			args.putParcelable(EmojiFragment2.ARG_EMOJI_TYPE, emojiType);
			mTabHost.addTab(tabSpec, EmojiFragment2.class, args);
			mTabHost.setTag(i);
