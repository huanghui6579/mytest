...
package net.ibaixin.joke.chat.view;
...
import net.ibaixin.joke.chat.fragment.EmojiTypeFragment.OnEmojiconBackspaceClickedListener;
import net.ibaixin.joke.chat.model.EmojiType;
import net.ibaixin.joke.chat.util.SystemUtil;
import net.ibaixin.joke.chat.view.EmojiPageIndicator.OnTabReselectedListener;
import net.ibaixin.joke.chat.view.EmojiPageIndicator.RepeatListener;
